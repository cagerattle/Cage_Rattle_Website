...
function themnific_add_javascript() {
		...
		wp_enqueue_script('brandsbox', get_template_directory_uri() .'/js/brandsbox.min.js','','', true);
		
		// Load homepage slider scripts		
		if (is_home()||is_single()||is_front_page()||is_page_template('template-fullwidth.php')||is_page_template('index.php')||is_page_template('homepage.php')||is_page_template('homepage-alt.php')) {

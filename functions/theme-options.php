...
$options[] = array( "name" => "Type of Slider",
					"desc" => "Choose Featured slider that you want to display in homepage.<br />- HD slider: displays full images (no overlay)<br />- LD slider: displays 1000x650px images (with overlay)",
...
$options[] = array( "name" => "General Text Font Style",
					...
					"std" => array('size' => '14','face' => 'Arial, sans-serif','style' => 'normal','color' => '#757575'),
					"type" => "typography"); 
...
$options[] = array( "name" => "Navigation Font Style",
					"desc" => "Select the typography you want for heading H1. <br />* semi-safe font <br />*** Google Webfonts (Must be allowed in General Settings tab).",
					"id" => $shortname."_font_nav",
					"std" => array('size' => '12','face' => 'Open Sans, sans-serif','style' => '700','color' => '#222'),
					"type" => "typography");  							
...
$options[] = array( "name" => "H1 Font Style",
					...
					"std" => array('size' => '70','face' => 'Montserrat, sans-serif','style' => '800','color' => '#000000'),
					"type" => "typography");  
...
$options[] = array( "name" => "H2 Style - Homepage",
					...
					"std" => array('size' => '80','face' => 'Montserrat, sans-serif','style' => '800','color' => '#000000'),
					"type" => "typography");  

$options[] = array( "name" => "H2 Style - Posts & Items",
					"desc" => "Select the typography you want for heading H2. <br />* semi-safe font <br />** @font-face rule <br />*** Google Webfonts (Must be allowed in General Settings tab).",
					"id" => $shortname."_font_h2",
					"std" => array('size' => '55','face' => 'Montserrat, sans-serif','style' => '800','color' => '#000000'),
					"type" => "typography");  
...
$options[] = array( "name" => "H3 Font Style + Slider Caption",
					...
					"std" => array('size' => '14','face' => 'Open Sans, sans-serif','style' => '700','color' => '#4a4a4a'),
					"type" => "typography"); 
...
$options[] = array( "name" => "H4 Font Style",
					...
					"std" => array('size' => '18','face' => 'Raleway, sans-erif','style' => '600','color' => '#000000'),
					"type" => "typography");  
...
$options[] = array( "name" => "H5 & H6 Font Style",
					...
					"std" => array('size' => '14','face' => 'Raleway, sans-serif','style' => '400','color' => '#4a4a4a'),
					"type" => "typography"); 
